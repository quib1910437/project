...
<section class="menu-section">
                            ...
                            <li><a href="dashboard.php" class="menu-top-active">DASHBOARD</a></li>
                             <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="my-profile.php">Profile của tôi</a></li>
    ...
    <?php } else { ?>
      ...
      <li><a href="index.php#ulogin">Đăng nhập</a></li>
                            <li><a href="signup.php">User Đăng ký</a></li>
                         
                            <li><a href="adminlogin.php">Là Admin?</a></li>
