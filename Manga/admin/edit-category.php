...
?>
    ...
    <head>
        ...
        <title>Online Manga Website | Chỉnh sửa thể loại</title>
    ...
    <div class=" content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Chỉnh sửa thể loại</h4>
                                ...
                                ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if ($result->Status == 1) { ?>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="status" id="status" value="1" checked="checked">Mở
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="status" id="status" value="1">Mở
                                                    </label>
                                                </div <?php } ?> </div>
                                        <?php }
                                } ?>
